...
set attack_counter=1
set attack_authenticating_detected=false

:attack_attempt_loop
if %attack_counter% equ 0 ( del /Q /F importwifi.xml 2>nul & goto :eof )
...
if "%interface_state%"=="connecting" ( call :color_echo . yellow "Connecting" & echo. )
...
:help
	...
	echo.
	echo  More projects from LePetiot37:
	echo  https://github.com/lepetiot37-jpn
	echo.
	echo.
